"""Master script: reproduces every table in the paper from the two raw CSVs.
...
def run_stage(n):
    t0 = time.time()
    if n == 1:
        print(">>> STAGE 1/4  building the analysis panel")
        import rep_data
        rep_data.build_panel()
    elif n == 2:
        print(">>> STAGE 2/4  Tables 1-6: descriptives, IRFs, convexity, mechanism,")
        print("               heterogeneity, robustness")
        import rep_tables
        rep_tables.main()
    elif n == 3:
        print(">>> STAGE 3/4  Table 7: double machine learning")
        import rep_dml
        rep_dml.main()
    elif n == 4:
        print(">>> STAGE 4/4  Tables 8-13: balance, diagnostics, stability,")
